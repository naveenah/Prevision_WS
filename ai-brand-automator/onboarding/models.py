...
class Company(models.Model):
    ...
    """
    tenant = models.OneToOneField(Tenant, on_delete=models.CASCADE, related_name='company')
    ...
    target_audience = models.TextField(blank=True, help_text="Description of target customers")
    core_problem = models.TextField(blank=True, help_text="Main problem the company solves")
    ...
    vision_statement = models.TextField(blank=True, help_text="AI-generated vision statement")
    mission_statement = models.TextField(blank=True, help_text="AI-generated mission statement")
    values = models.JSONField(default=list, help_text="List of core values")
    positioning_statement = models.TextField(blank=True, help_text="Market positioning statement")

    # Additional messaging
    tagline = models.CharField(max_length=255, blank=True, help_text="Brand tagline/slogan")
    ...
    color_palette_desc = models.TextField(blank=True, help_text="Color palette recommendations")
    font_recommendations = models.TextField(blank=True, help_text="Typography recommendations")
    messaging_guide = models.TextField(blank=True, help_text="Brand messaging guidelines")
...
class BrandAsset(models.Model):
    ...
    """
    tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='brand_assets')
    ...
    processed = models.BooleanField(default=False, help_text="Whether file has been processed")
...
class OnboardingProgress(models.Model):
    ...
    is_completed = models.BooleanField(default=False, help_text="Whether onboarding is fully complete")
