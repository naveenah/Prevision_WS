...
class CompanyAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('AI-Generated Content', {
            'fields': ('vision_statement', 'mission_statement', 'values', 'positioning_statement'),
            'classes': ('collapse',)
        }),
        ('Brand Messaging', {
        ...
        ('Brand Identity', {
            'fields': ('color_palette_desc', 'font_recommendations', 'messaging_guide'),
            'classes': ('collapse',)
        }),
        ('Metadata', {
...
class BrandAssetAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Storage', {
            'fields': ('gcs_path', 'gcs_bucket', 'processed')
        }),
        ('Metadata', {
            'fields': ('uploaded_at',),
            'classes': ('collapse',)
...
class OnboardingProgressAdmin(admin.ModelAdmin):
    list_display = ('tenant', 'company', 'current_step', 'completion_percentage', 'is_completed')
    ...
    fieldsets = (
        ('Progress Tracking', {
            'fields': ('tenant', 'company', 'current_step', 'completed_steps', 'is_completed')
        }),
        ('Timestamps', {
